...
class MjpegEncoder : public Encoder {
 ...
 private:
  // How many threads to use. Whichever thread is idle will pick up the next
  // frame.
  ...
  // encoders. The application can take its time, after which we return this
  // buffer to the encoder for re-use.
  void outputThread();

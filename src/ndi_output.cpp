...
NdiOutput::NdiOutput(VideoOptions const* options, std::string neopixelPath)
  ...
  // std::cout << "Width: " << options->width << " x Height: " <<
...
void NdiOutput::outputBuffer(void* mem, size_t size, int64_t timestamp_us,
                             uint32_t flags) {
...
bool NdiOutput::isProgram() { return this->program; }
bool NdiOutput::isPreview() { return this->preview; }
